...
<head>
	...
	<title>Sensory rooms design | CAPS Ltd</title> 
	<meta name="description" content="Sensory rooms: we design and build, unique, beautiful sensory rooms in the northwest, Northern Ireland and all of the island of Ireland.">
...
<div class="bc-body-wrap">
  ...
  <section id="body-content" class="bc-container " aria-label="Find out about our stylish featured walls and Ceilings">
    ...
    <div class="bc-flickity bc-flickity--feature-slider bc-media-component">
			...
			<article class="bc-flickity__slide" aria-label="Hero slide #1">
				<picture class="">
					<img src="../assets/media/star-ceiling-lights-2.jpg" alt="An example of calming ceiling lights for use in a sensory room" />
				</picture><!-- // .bc-hero__media -->
			</article><!-- // .bc-flickity__slide -->
