...
<head>
	...
	<link rel="stylesheet" href="https://use.typekit.net/lwq7zun.css">
  ...
  ?>
	...
	<body>
		<div class="bc-body-wrap">
			...
			<header class="bc-site-header bc-is-hero-overlay bc-container">
				<a title="Site hompepage" class="bc-site-header__home-link" href="/"> 
					<img src="./assets/media/caps-minimal-lc-final.svg" alt="CAPS Ltd logo - presenting Featured Walls and Ceilings" />
				</a>
			...
			<!-- Hero -->
			<section id="main-site-content" class="bc-hero has-lines" aria-label="Welcome to Featured Walls and Ceilings">
			...
			<section id="body-content" class="bc-container " aria-label="Find out about our stylish featured walls and Ceilings">
				...
				<div class="bc-grid bc-2-col-slider"> 
			...
			<!-- // Flickity hero slider -->
			<section class="bc-container bc-get-started">
      ...
      <?php 
        echo 'script src="assets/scripts/app-concat.js' . microtime() . '"></script>';
      ?>
		</div><!-- //. bc-body-wrap --> 
	</body>
</html> 