...
(function bcAppJS() {
  ...
  function bcAdjustHeight($el, target) {
    var speed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : .075;
  ...
  var twoColSliderObserveables = Array.from(document.querySelectorAll('.bc-2-col-slider .bc-flickity'));
